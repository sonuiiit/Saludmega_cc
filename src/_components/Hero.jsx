...
const HeroSection = ({ onClick }) => {
  return (
    <div className="relative w-full xl:h-[100vh] md:[h-80vh] h-[70vh]   flex items-center bg-cover bg-center bg-no-repeat">
      ...
      {/* Content Section */}
      <div className="relative w-full px-6 flex justify-center lg:justify-end lg:mx-20  lg:top-0">
        <div className="max-w-lg text-gray-600 text-center lg:text-right flex flex-col justify-center items-center">
          <h1 className="text-5xl md:text-4xl font-bold leading-tight font-poppins text-[#44494A] " >
            Impulsa Tu <br className="block md:hidden font-poppins" /> Bienestar
          </h1>
          ...
          <button
            ...
            className="mt-10 md:mt-6 bg-[#43525DE5] font-lato text-white text-lg px-8 py-4 rounded-xl shadow-md 
             hover:bg-gray-700 transition 
             backdrop-blur-md border border-gray-400 
