...
const sendMessage = async (contactMethod) => {
  ...
  return (
    <section className="bg-white flex justify-center py-12 px-0">
      <div className="flex flex-col-reverse lg:flex-row items-center max-w-5xl w-full rounded-lg">
        {/* Left Side - Image */}
        <div className="w-full lg:w-1/2 h-[400px] lg:h-[700px] mt-6 lg:mt-0">
          <img
            src="/images/WritingPhone.jpeg"
            alt="Contact Us"
            className="w-full h-full object-cover md:rounded-l-lg object-[20%_center]"
          />
        </div>
