...
export const Section3 = () => {
  return (
    <div className="relative  ">
      ...
      <div className="bg-[#00836999]/50 border border-[#1B7568]/30 text-white px-4  md:px-8 md:py-2 rounded-2xl flex flex-col 
                      md:w-84 w-54 h-24 md:h-36 backdrop-blur-md absolute top-[4px] left-[16px] md:top-5 md:left-5 lg:top-24 lg:left-48 xl:top-8 xl:left-60  shadow-lg">
